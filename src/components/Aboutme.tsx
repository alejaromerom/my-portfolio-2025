    ...
    <>
      <div className=" flex flex-col sm:flex-row items-center p-10">
        ...
        <div className="sm:w-2/3 sm:text-left sm:ml-10">
          ...
          <p className="rounded-lg border-2 p-8 border-accent text-white text-lg sm:text-xl transition ease-in-out delay-150 translate-y-1 hover:scale-105 hover:bg-transparent duration-300 motion-preset-flomoji-👉">
            Me encanta aprender cosas nuevas, me gusta la programación,la
            tecnología, y me gusta compartir lo que aprendo. <br />
            Soy Frontend Developer y trabajo con React, Express y Node js usando
            TypeScript, estoy aprendiendo TailwindCSS entre otras tecnologías.
            Me gusta la música, la fotografía, los gatos y la comida.
          </p>
        </div>
      </div>
    </>
